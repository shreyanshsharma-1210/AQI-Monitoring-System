...
export default function Dashboard() {
  ...
  const { cities, setCities, selectedCityId, setSelectedCityId, initSocket, liveUpdates, userProfile } = useStore();
  ...
  // Auto-select from profile or first city
  useEffect(() => {
    if (!selectedCityId && cities.length > 0) {
      const defaultId = userProfile?.preferred_city_id || cities[0].id;
      setSelectedCityId(defaultId);
    }
  }, [cities, selectedCityId, userProfile]);
    ...
    <div className="min-h-screen bg-gray-950 text-white">
        ...
        <div className="max-w-5xl mx-auto flex flex-wrap items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              disabled={loading}
              className="p-2 rounded-lg bg-gray-800 border border-gray-600 hover:border-gray-400 text-gray-300 hover:text-white transition-colors"
            >
      ...
      <div className="max-w-5xl mx-auto px-4 py-5 space-y-5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {/* AQI Gauge Card */}
          <div className="bg-gray-900 rounded-xl border border-gray-700 p-5 flex flex-col items-center gap-3">
        ...
        <div className="bg-gray-900 rounded-xl border border-gray-700 p-4">
          <h3 className="text-sm font-semibold text-white mb-3">
            Monitoring Stations in {cityName}
          </h3>
              ...
              {enrichedStations.map((s) => {
                ...
                return (
                  <button
                    ...
                    className="flex items-center gap-3 bg-gray-800 hover:bg-gray-700 rounded-lg px-3 py-2.5 text-left transition-colors"
                  >
                    <div
                    ...
                    <div className="min-w-0">
                      <p className="text-xs font-medium text-white truncate">{s.station_name}</p>
